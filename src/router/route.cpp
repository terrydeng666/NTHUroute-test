...
extern vector<Two_pin_list_2d *> net_2pin_list;

void release_static_memory()
{
...
int main(int argc, char *argv[])
{
    ...
    */
    ...
    try
    {
        ...
        std::cerr << std::endl
                  << "Runtime taken: " << time_span.count() << std::endl;
        ...
        std::cerr << std::endl
                  << "Main Route taken: " << time_span.count() << std::endl;
        fout << std::endl
             << "Main Route taken: " << time_span.count() << std::endl;

        time_span = duration_cast<duration<double>>(post_end - post_start);
        std::cerr << std::endl
                  << "Post Route taken: " << time_span.count() << std::endl;
        fout << std::endl
             << "Post Route taken: " << time_span.count() << std::endl;

        std::cerr << std::endl
                  << "Maze time taken: " << MAZE_TIME << std::endl;
        fout << std::endl
             << "Maze time taken: " << MAZE_TIME << std::endl;
        ...
        std::cerr << std::endl
                  << "Layer Assignment taken: " << (time_span.count() - IO_time) << std::endl;
        fout << std::endl
             << "Layer Assignment taken: " << (time_span.count() - IO_time) << std::endl;

        std::cerr << std::endl
                  << "I/O taken: " << IO_time << std::endl;
        fout << std::endl
             << "I/O taken: " << IO_time << std::endl;

        std::cerr << std::endl
                  << "Gamer time taken: " << GAMER_TIME << std::endl;
        fout << std::endl
             << "Gamer time taken: " << GAMER_TIME << std::endl;

        std::cerr << std::endl
                  << "Path search time taken: " << PATH_SEARCH_TIME << std::endl;
        fout << std::endl
             << "Path search time taken: " << PATH_SEARCH_TIME << std::endl;

        std::cerr << std::endl
                  << "DP time taken: " << DP_TIME << std::endl;
        fout << std::endl
             << "DP time taken: " << DP_TIME << std::endl;
        ...
        release_static_memory();
    }
    catch (const std::exception &e)
    {
        std::cerr << e.what() << "\n";
    } catch (...) {
        std::cerr << "Error: unknow\n";
    }
...
void dataPreparetionISPD2024(ParameterAnalyzer &ap, Builder *builder)
{
    ...
    Parser24(ap.get_cap_file(), ap.get_net_file()).parse(builder);
}
